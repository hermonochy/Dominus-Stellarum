...
class Galaxy:
    ...
    def _connect(
        ...
        self.neighbors[first_id].add(
            second_id
        )

        self.neighbors[second_id].add(
            first_id
        )
